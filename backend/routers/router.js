...
import {registerUser,sendOTP,validateOTP,getBrandProducts, loginUser,sendLoginOTP,userLogout,forgotsendOTP,updatePassword,homeBrand,getLatestProducts,homeRandomProducts,getProductDetail,getsimilarCategoryProduct,getAllProducts,userReviews,getReviews,userProfile,updateUserProfile,addUserAddress,getUserAddress,getAddressById,updateAddress,deleteAddress,removeWishlist,addWishlist,checkWishlist,addToCart,getWishlist,getCart,updateCart,removeCartItem,checkOutDetails,placeOrder,userOrderHistorys,getOrderDetails,cancelOrder,search,createRazorpayOrder,capturePayment,userCoupon,dshboard,getWallet,addWallet,getWalletBalance,updateWalletBalance,requestReturn,userCoupons,getCategories,getCategoryProduct
,getCategoryProducts,generateInvoice,paymentFailed,retryPaymentController,sendMail,changeProfilePassword} from '../controllers/controller.js'
...
router.post('/send-login-otp', isLogin, sendLoginOTP);
...
// Banner API for homepage
import Banner from '../models/bannerModel.js';
router.get('/homebanners', async (req, res) => {
  try {
...
router.post("/saveuserprofile", updateUserProfile);
router.post("/changepassword", isNotLogin, changeProfilePassword);
